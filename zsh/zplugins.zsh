...
zplugin ice lucid atload'![[ -f ${ZDOTDIR:-$HOME}/.p10k.zsh ]] && source ${ZDOTDIR:-$HOME}/.p10k.zsh >/dev/null'
...
#     has dependency on gawk
zplugin ice if"(( $+commands[gawk] ))"
zplugin load soimort/translate-shell

# ==> direnv
#     https://zdharma.org/zplugin/wiki/Direnv-explanation/
...
# zplugin creinstall %HOME/.local/share/zsh/site-functions  

autoload -Uz compinit
compinit
zplugin cdreplay -q # execute compdefs provided before compinit
